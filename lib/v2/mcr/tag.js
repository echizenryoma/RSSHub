...
module.exports = async (ctx) => {
    ...
    const data = await got.get(`https://mcr.microsoft.com/api/v1/catalog/${namespace}/tags?reg=mar`);
    const metadata = await got.get(`https://mcr.microsoft.com/api/v1/catalog/${namespace}/details?reg=mar`);
